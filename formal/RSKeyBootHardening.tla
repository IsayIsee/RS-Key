...
(*    `compact()` returns Ok (firmware/src/main.rs:658-669) -- marker AFTER  *)
...
(*    :1117-1119, crates/rsk-piv/src/lib.rs:1290-1293,                       *)
...
CONSTANTS
    ...
    \* The marker written on a lap that did NOT complete: firmware/src/main.rs:668
...
\* leaves the marker unset, firmware/src/main.rs:668).
