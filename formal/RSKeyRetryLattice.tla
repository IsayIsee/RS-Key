...
CONSTANTS
    ...
    \* crates/rsk-piv/src/lib.rs:1250-1252 (check_ref) and
    ...
    BugUseWhenBlocked,
    \* The decrement that IS the anti-bruteforce gate: crates/rsk-piv/src/lib.rs:1268
    ...
    \* crates/rsk-piv/src/lib.rs:1401 (`check_ref(EF_PUK, ..)` opens
...
\* RESET RETRY (crates/rsk-piv/src/lib.rs:582-589, crates/rsk-openpgp/src/pin.rs:770-820),
...
(***************************************************************************)
(* VERIFY. crates/rsk-piv/src/lib.rs:1245-1308 (check_ref) and              *)
