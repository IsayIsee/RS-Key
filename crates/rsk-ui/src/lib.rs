...
pub use render::{
    ...
    render_firmware, render_hold_button, render_hold_fill, render_home_change, render_keys_confirm,
    render_keys_decision, render_keys_status, render_keys_status_phase, render_keys_status_step,
