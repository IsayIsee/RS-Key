...
- **Seventeen firmware images**: `rs-key-<tag>-<flavor>.uf2`. Every published image
  ...
  | `display-keys` | + display-keys, `BOARD=waveshare-geek` | experimental touchless screen + button build (Waveshare RP2350-GEEK: ambient status, one-key confirm; [guides/display.md](guides/display.md)) |
